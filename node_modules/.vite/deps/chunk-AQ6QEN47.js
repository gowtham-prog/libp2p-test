...
var CID = class {
  ...
  static equals(self, other) {
    const unknown = other;
    return unknown && self.code === unknown.code && self.version === unknown.version && equals3(self.multihash, unknown.multihash);
  }
  toString(base3) {
...
function sizeForAddr(p, addr) {
  if (p.size > 0) {
    ...
    return size + (import_varint3.default.decode.bytes ?? 0);
  }
}
function bytesToTuples(buf) {
  ...
  while (i < buf.length) {
    ...
    i += size + n;
    if (i > buf.length) {
      throw ParseError("Invalid address Uint8Array: " + toString(buf, "base16"));
    }
...
var _DefaultMultiaddr = class {
  ...
  toString() {
    if (__privateGet(this, _string) == null) {
      __privateSet(this, _string, bytesToString(this.bytes));
    }
  ...
  tuples() {
    if (__privateGet(this, _tuples) == null) {
      __privateSet(this, _tuples, bytesToTuples(this.bytes));
    }
    return __privateGet(this, _tuples);
  }
  stringTuples() {
    if (__privateGet(this, _stringTuples) == null) {
      __privateSet(this, _stringTuples, tuplesToStringTuples(this.tuples()));
    }
  ...
  getPath() {
    if (__privateGet(this, _path) === void 0) {
      try {
        __privateSet(this, _path, this.stringTuples().filter((tuple) => {
        ...
        if (__privateGet(this, _path) == null) {
...
var DefaultMultiaddr = _DefaultMultiaddr;
_string = new WeakMap();
_tuples = new WeakMap();
...
//# sourceMappingURL=chunk-AQ6QEN47.js.map
